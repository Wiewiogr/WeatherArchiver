...
public class JsonStringToMongoDocumentConverterTest {
    ...
    String jsonWithoutWindDegree = "{\"coord\":{\"lon\":19.94,\"lat\":50.06},\"weather\":[{\"id\":801,\"main\":\"Clouds\",\"description\":\"few clouds\",\"icon\":\"02d\"}],\"base\":\"stations\",\"main\":{\"temp\":18,\"pressure\":1021,\"humidity\":48,\"temp_min\":18,\"temp_max\":18},\"visibility\":10000,\"wind\":{\"speed\":3.6},\"clouds\":{\"all\":20},\"dt\":1496908800,\"sys\":{\"type\":1,\"id\":5352,\"message\":0.004,\"country\":\"PL\",\"sunrise\":1496889102,\"sunset\":1496947649},\"id\":3085041,\"name\":\"Śródmieście\",\"cod\":200}";
    ...
    @Test
    public void convert_json_without_wind_degree_should_be_minus_one() throws Exception {
        Document document = converter.convert(jsonWithoutWindDegree);
        ...
        Assert.assertEquals(document.get("visibilty"), 10000);
        Assert.assertEquals(document.get("windSpeed"), 3.6);
        Assert.assertEquals(document.get("windDegree"), -1);
        Assert.assertEquals(document.get("clouds"), 20);
    }
}